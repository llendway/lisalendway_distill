...
Ok, this isn't really teaching material, but maybe it will help you learn `tidyverse` coding. For eight weeks in 2020-2021 (and hopefully starting again, soon!), I did screencasts working with the [Tidy Tuesday](https://github.com/rfordatascience/tidytuesday) data of the week. I only gave myself 30 minutes ... and maybe a little time after for some final touches. Links to the code and videos are on my [Github page](https://github.com/llendway/tidy_tuesday_in_thirty).
